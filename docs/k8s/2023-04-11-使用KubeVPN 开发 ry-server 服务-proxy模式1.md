# 使用 KubeVPN 快速开发 ry-server 服务 - proxy 模式
...
![img_1.png](../blog/img/img_1.png)

![img_2.png](../blog/img/img_2.png)

启动如果报错如下，请把环境变量中的 PATH 和 HOME 去掉

![img_3.png](../blog/img/img_3.png)

![img_5.png](../blog/img/img_5.png)
...
![img_7.png](../blog/img/img_7.png)

### 访问页面

观察到请求已经携带了正确的 header, 务必保证链路的 header 是透传的

![img_8.png](../blog/img/img_8.png)

本地已经收到请求

![img_6.png](../blog/img/img_6.png)
