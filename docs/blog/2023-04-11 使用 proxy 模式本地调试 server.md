...
![img_1.png](img/server_goland_config.png)

![img_2.png](img/server_goland_env_config.png)

启动如果报错如下，请把环境变量中的 PATH 和 HOME 去掉

![img_3.png](img/err_goland_debug_img.png)

![img_5.png](img/goland_startup_img.png)
...
![img_7.png](img/modify_header_img.png)

### 访问页面

观察到请求已经携带了正确的 header, 务必保证链路的 header 是透传的

![img_8.png](img/online_debug_img.png)

本地已经收到请求

![img_6.png](img/debug_breakpoint_img.png)
